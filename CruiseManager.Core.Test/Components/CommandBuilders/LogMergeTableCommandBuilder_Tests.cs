...
{
    public class LogMergeTableCommandBuilder_Tests : TestBase
    {
        public LogMergeTableCommandBuilder_Tests(ITestOutputHelper output) : base(output)
        {
        }
        ...
        public void MakeMergeTableCommand()
        {
            ...
            {
                var commandBuilder = new LogMergeTableCommandBuilder(database);
