...
namespace CSM.UI.CruiseCustomize
{
    public class CustomizeCruisePresenter : IPresentor
    {
        ...
        public DAL Database { get { return this.Controller.Database; } }
            ...
            try
            {
                ...
                foreach (FieldSetupStratum st in FieldSetupStrata)
                {
                    ...
                    List<TreeFieldSetupDO> unselectedTreeFields =
                        (from tfs in this.TreeFields.Except(st.SelectedTreeFields, CSM.DataTypes.TreeFieldComparer.Instance)
                         select new TreeFieldSetupDO(tfs)).ToList();
                    List<LogFieldSetupDO> unselectedLogFields = (
                        from lfs in this.LogFields.Except(st.SelectedLogFields, CSM.DataTypes.LogFieldComparer.Instance)
        ...
        public void LoadSampleGroups(TallySetupStratum stratum)
        {
            ...
            stratum.SampleGroups = Controller.Database.Read<TallySetupSampleGroup>("SampleGroup", "WHERE Stratum_CN = ?", stratum.Stratum_CN);
        ...
        public void HandleSave()
        {
            ...
            {
                this.Controller.ShowSimpleErrorMessage(errorBuilder.ToString());
            }
